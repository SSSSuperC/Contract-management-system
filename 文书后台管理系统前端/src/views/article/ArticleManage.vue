    ...
    <el-card class="page-container">
        <template #header>
            <div class="header">
                <span>契约管理</span>
                <div class="extra">
                    <el-button type="primary" @click="visibleDrawer = true">添加契约</el-button>
                </div>
            </div>
        </template>
        <!-- 搜索表单 -->
        <el-form inline>
            ...
            <el-form-item>
                ...
                <el-button @click="category_id = ''; state = ''">重置</el-button>
            </el-form-item>
        </el-form>
        <!-- 契约列表 -->
        <el-table :data="articles" style="width: 100%">
            <el-table-column label="契约标题" width="400" prop="title"></el-table-column>
        ...
        <!-- 抽屉 -->
        <el-drawer v-model="visibleDrawer" title="添加契约" direction="rtl" size="50%">
            <!-- 添加契约表单 -->
            <el-form :model="articleModel" label-width="100px">
                <el-form-item label="契约标题">
